...
function ModalConsultarInformacionMes(data) {
    ...
    $.ajax({
        url: "../Reportes/ReporteDetalleGarantiaPorMesesPorTipoCliente?tipoCliente=" + txtTipoCliente + "&ClienteClase=" + txtClienteClase + "&ClienteLinea=" + txtClienteLinea + " &Anio=" + txtFecha + " &Mes=" + data.Descripcion,
        type: "GET"
        , success: function (msg) {
            if (msg.length != 0) {
...
function ModalConsultarInformacionMesPorModelo(data) {
    ...
    var txtClienteLinea = $("#txtClienteLinea option:selected").val();
    $.ajax({
        url: "../Reportes/ReporteDetalleGarantiaPorMesesPorTipoClientePorModelo?tipoCliente=" + txtTipoCliente + "&ClienteClase=" + txtClienteClase + "&ClienteLinea=" + txtClienteLinea + " &Anio=" + txtFecha + " &Mes=" + data.Descripcion,
        type: "GET"
        , success: function (msg) {
            if (msg.length != 0) {
