            ...
            , success: function (msg) {
                ...
                $("#tblGarantiasRegistradas").dxDataGrid({
                    ...
                    columns: [
                        ...
                        {
                            dataField: "Cliente", caption: "Cliente", alignment: "left", allowFiltering: true, headerFilter: {
                                allowSearch: false
                            }
                        },                 
                        {
                            dataField: "NumeroComprobante", caption: "Comprobante", alignment: "left", allowFiltering: false, headerFilter: {
                                allowSearch: false
                            }
                        },                      
                        {
                            dataField: "Provincia", caption: "Provincia", alignment: "left", allowFiltering: false, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "Direccion", caption: "Direccion", alignment: "left", allowFiltering: false, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "Vendedor", caption: "Vendedor", alignment: "left", allowFiltering: true, headerFilter: {
                                allowSearch: false
                            }
                        },                      
                        {
                            dataField: "Modelo", caption: "Modelo", alignment: "left", allowFiltering: true, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "Lote", caption: "Lote", alignment: "left", allowFiltering: false, visible: false, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "Prorrateo", caption: "Prorrateo", alignment: "left", allowFiltering: false, visible: false, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "Meses", caption: "Meses", alignment: "left", allowFiltering: false, visible: false, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "PorcentajeVenta", caption: "Porcentaje Venta", alignment: "left", allowFiltering: false, visible: false, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "Voltaje", caption: "Voltaje", alignment: "left", allowFiltering: false, visible: false, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "ModoIngreso", caption: "Modo Ingreso", alignment: "left", allowFiltering: false, visible: false, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "FechaVenta", caption: "Fecha Venta", alignment: "left", dataType: "date", allowFiltering: true, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "FechaIngreso", caption: "Fecha Ingreso", alignment: "left", dataType: "date", allowFiltering: true, headerFilter: {
                                allowSearch: false
                            }
                        },
                        {
                            dataField: "AplicaGarantia", caption: "Aplica Garantia", alignment: "left", allowFiltering: true, headerFilter: {
                                allowSearch: false
                            }, visible:false
                        },
                        {
...
function ModalObtenerDiagnostico(datos) {
    ...
    $("#txtLoteFabricacion").val(datos.Lote);
...
function validarIngresos() {
    var valor1 = $("#txtLoteFabricacion").val();
...
function RegistrarAnalisisRegistroGarantia() {
    ...
    $.ajax({
        ...
        data: {
            IngresoRevisionGarantiaId: IdentificadorRevisionGarantia, LoteFabricacion: $("#txtLoteFabricacion").val(), LoteEnsamble: $("#txtLoteEnsamble").val(), LoteCarga: $("#txtLoteCarga").val(), ModeloBateria: $("#txtModeloBateria").val(),
