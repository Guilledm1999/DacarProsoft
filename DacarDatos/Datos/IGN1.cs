...
namespace DacarDatos.Datos
{
    ...
    public partial class IGN1
    {
        ...
        public string U_BPP_CTAD { get; set; }
        public string U_SYP_TipoServ { get; set; }
        public string U_SYP_CARPIMPD { get; set; }
        public string U_SYP_TIPDOC { get; set; }
        public string U_SYP_SERIEDOC { get; set; }
        public string U_SYP_NUMDOC { get; set; }
        public Nullable<System.DateTime> U_SYP_FECHADOC { get; set; }
        public string U_SYP_GUIAD { get; set; }
        public string U_SYP_COTID { get; set; }
        public string U_SYP_PEDCD { get; set; }
        public string U_SYP_DOCD { get; set; }
        public string U_SYP_OCOD { get; set; }
        public Nullable<System.DateTime> U_SYP_FLLMERCA { get; set; }
        public Nullable<System.DateTime> U_SYP_FEMBARCA { get; set; }
        public string U_SYP_TEMBAR { get; set; }
        public string U_SYP_CODCL { get; set; }
        public string U_SYP_NOMCL { get; set; }
        public string U_SYP_MOTCOM { get; set; }
        public string U_SYP_UBICAC { get; set; }
        public string U_SYP_CODIDTRD { get; set; }
        public string U_SYP_NROSOLIC { get; set; }
        public string U_SYP_NOMBRESN { get; set; }
        public Nullable<short> U_SYP_HORAED { get; set; }
        public Nullable<decimal> U_SYP_SDISP { get; set; }
        public Nullable<decimal> U_SYP_PRECIOU { get; set; }
        public Nullable<decimal> U_SYP_CANTIDAD { get; set; }
        public string U_SYP_CODART { get; set; }
        public string U_NOMBRECUENTA { get; set; }
        public string U_DC_PROMO { get; set; }
        public Nullable<decimal> U_DC_PESOBRUTO { get; set; }
        public Nullable<decimal> U_DC_PESOREAL { get; set; }
    }
}
