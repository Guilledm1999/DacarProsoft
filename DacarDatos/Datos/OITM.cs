...
namespace DacarDatos.Datos
{
    ...
    public partial class OITM
    {
        ...
        public string U_SYP_CODANT { get; set; }
        public string U_SYP_SUBCAT { get; set; }
        public string U_SYP_FLAG { get; set; }
        public string U_SYP_STOCKMIN { get; set; }
        public string U_SYP_CODVTA { get; set; }
        public string U_DAC_CODFERRI { get; set; }
        public string U_DAC_MARCA { get; set; }
        public Nullable<int> U_U_DAC_INDICE { get; set; }
        public string U_TIPO_CLIENTE { get; set; }
