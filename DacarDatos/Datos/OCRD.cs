...
namespace DacarDatos.Datos
{
    ...
    public partial class OCRD
    {
        ...
        public string U_SYP_NOMAVAL { get; set; }
        public string U_SYP_RUCAVAL { get; set; }
        public string U_SYP_TELEAVAL { get; set; }
        public string U_SYP_DIRAVAL { get; set; }
        public Nullable<System.DateTime> U_SYP_FC { get; set; }
        public Nullable<System.DateTime> U_SYP_FNACIM { get; set; }
        public string U_SYP_GENERO { get; set; }
        public string U_SYP_TITULO { get; set; }
        public string U_BPP_BPTD { get; set; }
        public string U_SYP_DIVISION { get; set; }
        public string U_SYP_CJAPPA { get; set; }
        public string U_SYP_CJAPMA { get; set; }
        public string U_SYP_CJNOMB { get; set; }
        public string U_SYP_CJCIPA { get; set; }
        public string U_SYP_CJLGNA { get; set; }
        public Nullable<System.DateTime> U_SYP_CJFCNA { get; set; }
        public string U_SYP_CJCELU { get; set; }
        public string U_SYP_CJEMAI { get; set; }
        public string U_SYP_REPLEGAL { get; set; }
        public string U_SYP_LINEASN { get; set; }
        public string U_SYP_CLASESN { get; set; }
        public Nullable<short> U_SYP_DEMERC { get; set; }
        public string U_SYP_MPAGARE { get; set; }
        public Nullable<decimal> U_SYP_VPAGARE { get; set; }
        public Nullable<decimal> U_SYP_SEGURO { get; set; }
        public Nullable<System.DateTime> U_SYP_FNACIMIENTO { get; set; }
        public string U_SYP_UserSign_PV { get; set; }
        public string U_SYP_PARTREL { get; set; }
        public string U_SYP_TIPPROV { get; set; }
        public string U_SYP_BPE_FPAGO { get; set; }
